...
class Transaction_Table(models.Model):
    ...
    block_hash_id = models.CharField(max_length=200)
    transaction_hash = models.CharField(max_length=200, null=False)
    timestamp =  models.DateTimeField(db_index=False,null=False)
...
class Input_Table(models.Model):
    ...
    previous_transaction_hash = models.CharField( max_length=200, null=True)
